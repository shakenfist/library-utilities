...
2. Navigate to your project: `shakenfist-utilities`
...
6. Fill in the form:
   - **Owner**: `shakenfist`
   - **Repository name**: `library-utilities`
...
**Note**: If the `shakenfist-utilities` package already exists on PyPI under
...
1. Go to the repository on GitHub: `shakenfist/library-utilities`
...
cosign verify-attestation \
    ...
    --certificate-oidc-issuer='https://token.actions.githubusercontent.com' \
    shakenfist-utilities-0.1.0.tar.gz
```
